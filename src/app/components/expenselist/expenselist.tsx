...
import ExpenseModal from '../expenseModel/expenseModel';
...
const ExpenseList = () => {
  ...
  return (
    <div className="m-8">
      ...
      <BarChart width={500} height={300} data={expenses} className=' bg-yellow-700'>
        <CartesianGrid stroke="#eee" strokeDasharray="5 5" />
        <XAxis dataKey="category" stroke="#fff" tick={{ fill: '#fff', fontWeight: 'bold' }} />
        <YAxis stroke="#fff" tick={{ fill: '#123', fontWeight: 'bold' }} />
